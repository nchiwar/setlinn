...
// // --- CAROUSEL DATA AND SLIDE CONTENT ---

// const slidesData = [
//   {
//     id: 1,
//     title: "Explore the Future of Education",
//     description: "Discover innovative courses designed for tomorrow's leaders.",
//     ctaText: "Enroll Now",
//     image:
//       "https://placehold.co/1200x600/155e75/ffffff?text=Slide+1%3A+Innovation",
//     align: "center",
//   },
//   {
//     id: 2,
...
//     image:
//       "https://placehold.co/1200x600/0d9488/ffffff?text=Slide+2%3A+Community",
//     align: "start",
//   },
//   {
//     id: 3,
...
//     image: "https://placehold.co/1200x600/0f766e/ffffff?text=3%3A+Resources",
//     align: "end",
//   },
//   {
//     id: 4,
...
//     image: "https://placehold.co/1200x600/16a34a/ffffff?text=4%3A+Waitlist",
//     align: "center",
//   },
// ];
...
//             className="px-8 py-3 h-auto text-lg font-bold"
//           >
//             {slide.ctaText}
//           </Button>
//         </div>
...
// //   const { currentSlide, setCurrentSlide } = React.useContext(CarouselContext);
...
// "use client"; // REQUIRED: This component uses client-side hooks
...
// // --- CAROUSEL DATA AND SLIDE CONTENT (No changes) ---
...
//         backgroundSize: "cover",
//         backgroundPosition: "center",
//         minHeight: "400px", // Added for visual stability
//       }}
//     >
//       {/* Dark Overlay for Text Readability */}
//       <div className="absolute inset-0 bg-black/40"></div>
...
//             {slide.description}
//           </p>
//           {/* Using 'default' variant as 'customPrimary' might not be defined */}
//           <Button
//             variant="default"
//             className="px-8 py-3 h-auto text-lg font-bold"
//           >
...
// // --- CORRECTED CONTEXT & INDICATOR ---

// // Initialize the context with an object containing default/placeholder values
// // This prevents the "Cannot destructure property... as it is null" error
// const CarouselContext = React.createContext({
//   currentSlide: 0,
//   handleDotClick: () => {}, // placeholder function
// });

// const CarouselIndicator = ({ slides }) => {
//   // Destructure values from the context safely
//   const { currentSlide, handleDotClick } = React.useContext(CarouselContext);
...
//               : "bg-white/50 hover:bg-white/80"
//           }`}
//           // Use the provided function from the context to scroll
...
// function Hero() {
//   // 1. State to capture the Carousel API object
//   const [api, setApi] = useState();
//   // 2. State to track the current slide index
//   const [currentSlide, setCurrentSlide] = useState(0);

//   // 3. Function to handle dot clicks (scrolls the carousel using the API)
//   const handleDotClick = useCallback(
//     (index) => {
//       // Check if API is available before calling scrollTo
//       if (api && api.scrollTo) {
//         api.scrollTo(index);
//       }
//     },
...
//   // 4. Effect to listen to the carousel's 'select' event and update state
//   useEffect(() => {
//     if (!api) return;

//     // Function to update the index
//     const onSelect = () => {
//       // api.selectedScrollSnap() returns the current 0-based index
//       setCurrentSlide(api.selectedScrollSnap());
//     };

//     // Set initial index and attach the listener
//     onSelect();
...
//   return (
//     // 5. Wrap the Carousel and Indicator with the context provider, passing the state/handlers
//     <CarouselContext.Provider value={contextValue}>
//       <div className="relative">
//         {" "}
//         {/* Use relative positioning for the indicator */}
//         <Carousel
//           className="w-full"
//           setApi={setApi} // 6. Pass the API setter to the Carousel
//           opts={{ loop: true }} // Optional: a nice feature to add
//         >
    ...
    >
      ...
      >
        <div className="max-w-3xl text-white">
          ...
          <Button
            variant="outline"
            className="px-8 py-3 h-auto text-lg font-bold border-[#207681] cursor-pointer"
          >
            {slide.ctaText2}
          </Button> */}
        </div>
